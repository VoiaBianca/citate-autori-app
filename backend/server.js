...
Number(q.id))) + 1 : 1;
const newQuote = { id: newId.toString(), ...req.body }; // convertim
//ID-ul in sir pentru a se potrivi cu formatul db.json
...
const reorderedData = { id: data.id, author: data.author, quote:
data.quote };
