...
<div className="flex flex-col justify-between bg-white rounded-2xl
shadow-md
...
<p className="text-gray-700 text-base italic leading-relaxed mt-
1">
{quote.quote}
</p>
</div>
{/* Autorul — aliniat la dreapta, subliniat */}
<p className="text-right text-sm font-semibold text-brand-dark mt-
4">
— {quote.author}
</p>
