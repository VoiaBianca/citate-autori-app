...
justify-between">
<div>
<h1 className="text-2xl font-bold text-brand">Citate Autori
Celebri</h1>
...
<p className="text-gray-400 text-xl mb-4">Nu există citate
încă.</p>
<Link to="/manage" className="text-brand underline hover:text-
brand-dark">
Adaugă primul citat →
</Link>
</div>
